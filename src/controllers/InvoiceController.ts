...
import { ApiError, SortOrder, InvoiceStatus, InvoiceStats } from '@/types';
...
export const CreateInvoiceSchema = z.object({
  ...
  status: z.enum(['PENDENTE', 'PAGO'], { required_error: 'O campo é obrigatório.', message: 'O status deve ser PEDENTE ou PAGO.' })
});
...
export const InvoiceController = {
  ...
  async remove(id: string) {
    ...
    return { status: 200, body: { message: 'Fatura removida com sucesso.' } }
  }
};